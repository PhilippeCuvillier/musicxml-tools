...
<xsl:stylesheet
   ...
   exclude-result-prefixes="xsl mynamespace">
   
<!--   <mynamespace:accidentals>
   ...
   -->   
<!--   <xsl:variable name="fifthsCycle" select="document('')/*/mynamespace:fifthsCycleAA"/>-->
   
   <xsl:variable name="fifthsCycleAAA">
      <pitch>
         <step>F</step>
         <alter>-2</alter>
      </pitch>
...
<!--   <xsl:variable name="fifthsCycleAA" select="document('./fifthsCycle.xml')/fifthsCycle"/>-->
   
   <xsl:variable name="fifthsCycle" select="exsl:node-set($fifthsCycleAAA)"/>
   
   <!--
      Array of MusicXML <accidentals> elements
   -->
<!--   <xsl:variable name="accidentalsMusicXml" select="document('')/*/mynamespace:accidentals"/>-->
   <xsl:variable name="accidentalsAAA">
      <accidental>flat-flat</accidental>
      <accidental>flat</accidental>
      <accidental>natural</accidental>
      <accidental>sharp</accidental>
...
<!--   <xsl:variable name="accidentalsAA" select="document('./accidentalsMusicXml.xml')/accidentals"/>-->
   
   <xsl:variable name="accidentalsMusicXml" select="exsl:node-set($accidentalsAAA)"/>
